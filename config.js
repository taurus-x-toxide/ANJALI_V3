...
module.exports = {
    ...
    SESSION: process.env.ANJALI_SESSION === undefined ? '' : process.env.ANJALI_SESSION,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Anjali' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'MUHAMMED AND AKSHAY' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝ᴀɴᴊᴀʟɪ࿐' : process.env.BOT_NAME,
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://firebasestorage.googleapis.com/v0/b/photo-to-link.appspot.com/o/681277785?alt=media&token=87f207fc-c7c7-4903-8366-2d3bdc17fa67' : process.env.ALL_IMG,
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/_taurus.exe/' : process.env.SOCIAL_MEDIA,
